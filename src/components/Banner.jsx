...
import Doctor from "../assets/images/doctorbanner.png";
        ...
        <div className="px-3 py-4 md:py-12 lg:my-0 md:px-12 text-gray-800 text-center lg:text-left">
          <div className="container mx-auto xl:px-32">
            <div className="grid lg:grid-cols-2   items-center">
              <div className="mt-0 lg:mt-0 order-2 md:order-1">
                <h1 className="text-3xl md:text-6xl xl:text-5xl font-semibold tracking-wider mb-8 md:mb-12">
                  Your New Smile <br />
              ...
              <div className="mb-12 lg:mb-0 order-1 md:order-2">
                <img
                  src={Doctor}
